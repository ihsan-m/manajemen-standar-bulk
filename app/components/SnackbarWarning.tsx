...
const SnackbarWarning: React.FC<SnackbarProps> = ({
  ...
  return (
    <>
      {/* Alerts: Success */}
      <div
        className={`fixed bottom-20 left-20 md:bottom-10 md:left-10 mb-4 ml-4 p-4 md:p-5 rounded text-orange-700 bg-orange-100 min-w-[450px] `}
      >
        {" "}
        <div className="flex flex-row space-x-10">
          <div className="flex items-center mb-2 space-x-2">
            <AiFillWarning className="text-orange-700" />
            <h3 className="font-semibold">Warning!</h3>
            <button
              onClick={() => setShowSnackbar(false)}
              className="text-orange-500 hover:ring-2 ring-orange-500"
            >
              Closes in {countdown} ...
            </button>
          </div>
